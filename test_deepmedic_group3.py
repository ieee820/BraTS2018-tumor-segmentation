...
models_group1 = ['deepmedic_ce_c25_90_120_150_b50_mb50_all']

models_group2 = ['deepmedic_ce_c25_75_100_125_b50_mb50_all', 'deepmedic_ce_45_60_75_b50_mb50_all']
...
for model in models_group3:
	print(model)
	call(['python', 'predict.py', '--gpu', '3', '--cfg', model])
